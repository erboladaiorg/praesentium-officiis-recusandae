...
[![GitHub](https://img.shields.io/github/license/erboladaiorg/praesentium-officiis-recusandae)](https://github.com/erboladaiorg/praesentium-officiis-recusandae/)
...
[![npm](https://img.shields.io/npm/v/@erboladaiorg/praesentium-officiis-recusandae?label=npm%20%5Bnode%5D)](https://www.npmjs.com/package/@erboladaiorg/praesentium-officiis-recusandae)
...
```console
yarn global add @erboladaiorg/praesentium-officiis-recusandae-demo
```
...
```console
yarn add @erboladaiorg/praesentium-officiis-recusandae
```

Create instances of the Cobra class:

```javascript
const { Cobra } = require("@erboladaiorg/praesentium-officiis-recusandae");
